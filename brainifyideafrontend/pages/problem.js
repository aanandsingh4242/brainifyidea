  ...
  return (
    <>
      <div className={styles.jpt}>
        <Head>
          <title>Brainify Idea | Problem</title>
          ...
          <Row className={styles.row}>
            <Col sm className={styles.column_first}>
              <div className={styles.main_content}>
                <h1 className={styles.main_heading}>Share your problem with the world.</h1>
                <p>Mention your problems here so that the person who see your problem may give you some better Idea regarding that problem.</p>
              </div>
            ...
            <Col sm className={styles.column_second}>
              <Image src="/../public/problem_solving.png" width={664} height={500}></Image>
            </Col>
